...
import { ordersList, PAYMENT_OPTIONS } from './const';
    ...
    <MainTemplate title="Orders">
      ...
      <BlockContainer>
        ...
        <FlexRow>
          ...
          <CustomDatePicker data={ordersList} setData={searchByDate} />
          <FilterButton active={filtersShow} setFilters={setFiltersShow} />
          <Button handler={showRemove}>Remove order</Button>
        </FlexRow>
        {filtersShow ? <Select options={PAYMENT_OPTIONS} handler={searchByPayment} /> : null}
